...
ActiveRecord::Schema.define(version: 20141015151220) do
  ...
  create_table "spree_omnikassa_payments", force: true do |t|
  ...
  add_index "spree_suppliers_taxons", ["supplier_id"], name: "index_spree_suppliers_taxons_on_supplier_id", using: :btree
  add_index "spree_suppliers_taxons", ["taxon_id"], name: "index_spree_suppliers_taxons_on_taxon_id", using: :btree
