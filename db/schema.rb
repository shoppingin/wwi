...
ActiveRecord::Schema.define(version: 20140912061747) do
  ...
  add_index "spree_suppliers_taxons", ["supplier_id"], name: "index_spree_suppliers_taxons_on_supplier_id"
  add_index "spree_suppliers_taxons", ["taxon_id"], name: "index_spree_suppliers_taxons_on_taxon_id"
